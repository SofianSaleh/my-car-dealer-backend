...
var User_Stats = (function (_super) {
    __extends(User_Stats, _super);
    function User_Stats() {
    ...
    ], User_Stats.prototype, "id", void 0);
    __decorate([
        type_graphql_1.Field(),
        typeorm_1.ManyToOne(function (_type) { return User_1.User; }, function (user) { return user.id; }),
        __metadata("design:type", User_1.User)
    ], User_Stats.prototype, "user_id", void 0);
    __decorate([
        type_graphql_1.Field(),
        typeorm_1.Column({ type: 'int', nullable: true, default: 0 }),
        __metadata("design:type", Number)
    ], User_Stats.prototype, "cars_sold", void 0);
    __decorate([
        type_graphql_1.Field(),
        typeorm_1.Column({ type: 'int', nullable: true, default: 0 }),
        __metadata("design:type", Number)
    ], User_Stats.prototype, "cars_bought", void 0);
    User_Stats = __decorate([
